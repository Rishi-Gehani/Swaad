...
const menuData = {
  sindhi: {
    ...
    customize: {
      Snacks: [
        ...
        { id: 3, name: 'Sana Pakoda', price: 299, description: '1 Tray = 10 Serves.', image: 'https://www.secondrecipe.com/wp-content/uploads/2020/01/sanna-pakoda-720x823.jpg' },
      ...
      Rice: [
        ...
        { id: 9, name: 'Spl. Sindhi Bhuga Chawal(Brown Rice)', price: 1099, description: '1 Tray = 10 Serves.', image: 'https://thumbs.dreamstime.com/b/appetizing-brown-rice-wooden-bowl-rustic-table-high-quality-image-cooked-raw-grains-herbs-around-318091020.jpg' },
    ...
    packages: [
      ...
      { id: 43, name: 'Rishit ka Zaika Jalwa Thali ', price: 1297, description: 'Dal Pakwan(x1) , Mirchi Bhajiya(x2) , Besan Koki(x2) , Tea/Coffee(x1) | 1 Tray = 10 Serves',  image: 'https://images.immediate.co.uk/production/volatile/sites/2/2022/12/Sindhi-dhal-pakwan-65b6f64.jpg?quality=90&resize=708,643' },
      { id: 44, name: 'Rishi’s Royal Feast Thali', price: 6434, description: 'Jeera Rice , Spl. Sindhi Kadhi(Besan) , Butter Roti(x2) , Palak Paneer, Aalo Bhindi , Singhar Mithai(x2) , Boondi Raita(x1) | 1 Tray = 10 Serves',  image: 'https://i.pinimg.com/736x/be/c7/6f/bec76fbbc99c15db930e8128b8ca13e6.jpg' },
      { id: 45, name: 'Rishit’s Tadka Triumph', price: 6370, description: 'Spl. Sindhi Tairi , Sai Bhaji , Butter Garlic Naan(x2), Paneer Butter  Masala , Masala Beeh , Spl. Sindhi Lola(x2) , Masala Papad| 1 Tray = 10 Serves',  image: 'https://images.pexels.com/photos/5775684/pexels-photo-5775684.jpeg' },
      { id: 46, name: 'Swaad Sangam Thali', price: 6314, description: 'Spl. Sindhi Bhuga Chawal , Chana Masala , Spl. Sindhi Doda(x2) , Paneer Bhurji , Aalo Baigan , Moong dal Halwa(x1) , Boondi Raita(x1) | 1 Tray = 10 Serves' ,image: 'https://i.pinimg.com/1200x/37/4f/97/374f975f1a232625ef1f8114badb6b80.jpg' },
  ...
  gujarati: {
    ...
    packages: [
        { id: 71, name: 'Full On Heet Feast Thali', price: 1101, description: 'Khaman , Patra , Fafda , Jalebi , Tea/Coffee | 1 Tray = 10 Serves ', image: 'https://i.pinimg.com/1200x/6c/e6/e2/6ce6e21e0f67d015f6863907d7e87c56.jpg' },
        { id: 72, name: 'Jashn-e-Jasleen Thali', price: 1101, description: 'Dhokla , Khandvi , Fafda Jalebi , Tea/Coffee | 1 Tray = 10 Serves ', image: 'https://i.pinimg.com/1200x/c8/1a/ac/c81aac38467e652c2c611e4f6248aedf.jpg' },
        { id: 73, name: 'Ruchi ki Rasoi Rangilo Thali', price: 4075, description: 'Spl. Gujarati Masala Khichdi , Ringan Nu Olo , Roomali Roti(x2) , Undhiyu , Kesar Basundi(x1), Masala Chaas(x1) | 1 Tray = 10 Serves ', image: 'https://i.pinimg.com/1200x/d4/6a/7e/d46a7e9f0fc95c469eb2aa12d49fea6d.jpg' },
        { id: 74, name: 'Swaad Sutra Thali', price: 5482, description: 'Peas Pulao , Dal Takda , Vaal Nu Saak , Thepla(x2) , Barela Bhindi , Laapsi , Boondi Raita(x1) | 1 Tray = 10 Serves ', image: 'https://i.pinimg.com/736x/fb/91/36/fb9136b7267fc5ec11758b125d7671b7.jpg' },
        { id: 75, name: 'Royal Rasoi Thali', price: 4955, description: 'Biryani , Sev Tameta , Butter Garlic Naan(x2) , Mix Veg , Rabdi , Masala Chaas(x1) | 1 Tray = 10 Serves ', image: 'https://images.pexels.com/photos/5775684/pexels-photo-5775684.jpeg' },
  ...
  marathi: {
    ...
    customize: {
      ...
      Deserts: [
        { id: 93, name: 'Ukdi che Modak', price: 499, description: '1 Tray = 50 Modaks.', image: 'https://imgs.search.brave.com/jeaDZMWw5Dy4LH4_y1d-6Npwj1VjaybmsuK6zhyGxJA/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90NC5m/dGNkbi5uZXQvanBn/LzAzLzczLzA2Lzk1/LzM2MF9GXzM3MzA2/OTUxN19XUUlxU0M1/SUIzSFp1Y0FLUnNn/Y2xhUzhZR2hwejlU/TC5qcGc' },
    ...
    packages: [
        { id: 97, name: 'Janhavi Zaayka Thali ', price: 1314, description: 'Misal Pav, Puran Poli, Batata Vada , Tea/Coffee | 1 Tray = 10 Serves', image: 'https://i.pinimg.com/1200x/e4/43/ff/e443ffd83569b11fcf35e3e0d93efe3c.jpg' },
        { id: 98, name: 'Taste-e-Tanvi Thali', price: 1059, description: 'Misal Pav, Kandha Poha, Sabudana , Tea/Coffee| 1 Tray = Serves', image: 'https://i.pinimg.com/1200x/57/f9/22/57f92279c050bdbe0275174df2d7bbe2.jpg' },
        { id: 99, name: 'Rishi’s Rasoi Royale Thali', price: 4915, description: 'Jeera Rice , Bharli Vangi , Bhakri(Jawari)(x2) , Methi Chi Patal , Modak(x5) , Masala Papad(x1) | 1 Tray = Serves ', image: 'https://i.pinimg.com/1200x/5a/9b/8a/5a9b8a4f49ab9529a72b50fa2092978e.jpg' },
        { id: 100, name: 'Sohan’s Swadisht Surprise Thali', price: 4475, description: 'Jeera Rice , Dal Takda , Sev Bhaji , Bhakri(Rice)(x2) , Paneer Burji , Gajar Halwa(x1) , Boondi Raita(x1) | 1 Tray = Serves', image: 'https://i.pinimg.com/736x/57/be/f8/57bef8263140b6aef13a196bd09ff99e.jpg' },
        { id: 101, name: 'Tanvi’s Taste Trek Thali', price: 7394, description: 'Jeera Rice , Pitla , Thaalipeeth(x2) , Aalo chi Bhaji , Chana Masala , Shrikhand(x1) , Masala Chaas(x1) | 1 Tray = Serves', image: 'https://i.pinimg.com/1200x/6b/b9/bc/6bb9bc070dfe2c4b6e9e9ea4aa79e4ef.jpg' },
      ],
  },
};
